...
namespace Dental.Infrastructure.Migrations
{
    ...
    [Migration("20260810051424_UpdateVisitTreatments_AddColumnCount_RenamePriceToTreatmentPrice")]
    partial class UpdateVisitTreatments_AddColumnCount_RenamePriceToTreatmentPrice
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("VisitTreatments", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_VisitTreatments_ToothNumber_Range", "[ToothNumber] = NULL OR [ToothNumber] BETWEEN 1 AND 32");
                        });
                });
