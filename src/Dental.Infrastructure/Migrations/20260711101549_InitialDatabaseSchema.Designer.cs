...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dental.Domain.Entities.Patient", b =>
                {
                    ...
                    b.ToTable("Patients", null, t =>
                        {
                            t.HasCheckConstraint("CK_Patient_Gender", "Gender IN (1, 2)");
                        });
                });
            ...
            modelBuilder.Entity("Dental.Domain.Entities.VisitToothTreatment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("VisitToothTreatments", null, t =>
                        {
                            t.HasCheckConstraint("CK_VisitToothTreatments_Price_NonNegative", "[Price] >= 0");

                            t.HasCheckConstraint("CK_VisitToothTreatments_ToothNumber_Range", "[ToothNumber] >= 1 AND [ToothNumber] <= 32");
                        });
                });
            ...
            modelBuilder.Entity("Dental.Domain.Entities.Treatment", b =>
                {
                    b.Navigation("VisitToothTreatments");
                });
